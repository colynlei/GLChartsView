//
//  ChartsCustomFocusAnimationViewController.m
//  GLChartsView
//
...
#import "ChartsCustomFocusAnimationViewController.h"
#import "CustomHighlightFocusAnimationView.h"
#import <GLMacro.h>


@interface ChartsCustomFocusAnimationViewController ()

@property (nonatomic, strong) GLChartsView *chartsView;
@property (nonatomic, strong) CustomHighlightFocusAnimationView *focusView;

@end

@implementation ChartsCustomFocusAnimationViewController
...
- (CustomHighlightFocusAnimationView *)focusView {
    if (!_focusView) {
        _focusView = [[CustomHighlightFocusAnimationView alloc] initWithFrame:CGRectMake(0, 0, 8, 8)];
    }
    return _focusView;
}
